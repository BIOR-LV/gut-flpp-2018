...
EVALVIZ=$TESTRUN/evcomp-atcc-6.qzv
FILTERDATA=$PROJDIR/data/mock/samples-to-keep-atcc.tsv
EXPTABLEIN=$PROJDIR/data/mock/atcc-expected-rel-ftab.tsv
EXPTABLEOUT=$PROJDIR/data/mock/atcc-expected-rel-ftab.qza
